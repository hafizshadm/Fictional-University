...
class MyNotes {
  ...
  createNote(e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      error: err => {
        if (err.responseText == "Your posts limit increase") {
...
class Search {
  ...
  constructor() {
    ...
    this.openSearchBtn = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".js-search-trigger");
    this.closeSearchBtn = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".search-overlay__close");
      ...
      this.resultsDiv.html(`
        ...
        ${results.generalInfo.length ? "</ul>" : ""}
          ...
          <div class="one-third">
            ...
            ${results.campuses.length ? '<ul class="link-list min-list">' : "<p>No program matches that search.</p>"}
  ...
  openOverlay() {
    ...
    setTimeout(() => this.searchField.focus().bind(this), 300);
  ...
  addSearchHTML() {
    ...
    <div class="container">
      ...
      <input type="text" name="search-term" id="search-term" class="search-term" autocomplete="off" placeholder="What are you looking for?">

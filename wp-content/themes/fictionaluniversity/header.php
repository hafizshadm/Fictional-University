...
<body <?php body_class(); ?>>
  <header class="site-header">
    <div class="container">
      ...
      <a href="<?php site_url('/search') ?>" class="js-search-trigger site-header__search-trigger"><i class="fa fa-search" aria-hidden="true"></i></a>
      ...
      <div class="site-header__menu group">
        ...
        <div class="site-header__util">
          ...
          <?php }
          ?>
          <a href="<?php site_url('/search') ?>" class="search-trigger js-search-trigger"><i class="fa fa-search" aria-hidden="true"></i></a>
        </div>
      </div>
    </div>
  </header>
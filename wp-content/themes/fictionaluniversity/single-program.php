...
?>
  <div class="container container--narrow page-section">
    ...
    if ($relatedProfessors->have_posts()) {
      ...
      echo '<h2 class="headline headline--small">Related ' . get_the_title() . ' Professor(s)</h2>';
    ...
    if ($programRelatedEvents->have_posts()) {
      echo '<hr class="section-break">';
      echo '<h2 class="headline headline--small">Upcoming ' . get_the_title() . ' Event(s)</h2>';
